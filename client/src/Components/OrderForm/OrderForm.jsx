            ...
            {loading ? (
                ...
                <div className="orderSuccess">
                    ...
                    <div className="successMessage">
                        ...
                        <button onClick={handleBackToMenu} className="back-to-menu-button" type="button">Back to the menu</button>
                    </div>
                </div>
            ) : (
                <form onSubmit={handleClick}>
                    ...
                    <div className="delivery-input">
                        <input type="text" id="country" name="country" placeholder="Country" value={formData.country} onChange={handleChange} required />
                        <div className="delivery-input-name-line">
                            <input style={{ marginRight: "10px" }} type="text" id="firstName" name="firstName" placeholder="First name" value={formData.firstName} onChange={handleChange} required />
                        ...
                        <input type="text" id="company" name="company" placeholder="Company (optional)" value={formData.company} onChange={handleChange} />
